import { DEFAULT_PAGE_SIZE, getAllSpecies, getPokedex } from '@/services/pokemon';
...
const getPageSize = (currentPage: number, totalPages: number, totalItems: number): number => {
