...
import { type PokemonChainData, type PokemonEvolutionLine, type PokemonInfo } from "@/types/pokemon";
...
const usePokemonEvolution = (id: number, evolutionUrl: string): PokemonEvolutionHook => {
  ...
  const getEvolutionLine = useCallback(async (
